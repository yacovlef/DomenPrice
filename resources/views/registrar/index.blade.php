      ...
      <table class="table">
        ...
        <tbody>
          @foreach ($registrars as $registrar)
            <tr>
              <td class="text-center"><img src="{{ Storage::url($registrar->logo) }}" alt="registrar_logo"> <a href="{{ route('registrars.show', ['slug' => $registrar->slug]) }}" class="text-dark">{{ $registrar->name }}</a></td>
