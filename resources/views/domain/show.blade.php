        ...
        <tbody>
          @foreach ($prices as $price)
            <tr>
              ...
              <td class="text-center"><img src="{{ Storage::url($price->registrar->logo) }}" height="25" alt="registrar_logo"> <a href="{{ $price->registrar->www }}" target="_blank" class="text-dark">{{ $price->registrar->name }}</a></td>
            </tr>
          @endforeach
        </tbody>
      </table>
